...
/**
 * Represents a failure scenario to be simulated.
 */
public class FailureScenario {

    private String name;
    private String description;
    private List<FailureStep> steps;
     ...
     */
    public FailureScenario(String name, String description) {
        this.name = name;
    ...
    public List<FailureStep> getSteps() {
        return steps;
    }

    public void setSteps(List<FailureStep> steps) {
        this.steps = steps;
    }
